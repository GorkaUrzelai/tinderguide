...
import com.bergara.tinder.app.Async.SynContent;
    ...
    private void connectBridge(int position){
        ...
        try {
            ...
            if (GFX.ONLINE_OFFLINE){
                if(GFX.useCRYPTDATA){
                    setBridgeOnline(Hexing.getStrings(GFX.JSONLINK_on),String.valueOf(position));
                }else {
                    setBridgeOnline(GFX.JSONLINK_on,String.valueOf(position));
                }
    ...
    private void showNative(FrameLayout frameLayout){
        ...
        if(GFX.ONLINE_OFFLINE){
            ...
            if (myApplication.defualtAd.equalsIgnoreCase(GFX.Tags.AdMob)){
                ...
                setNativeAdMob(frameLayout,myApplication.natAdMob);


            }else if (myApplication.defualtAd.equalsIgnoreCase(GFX.Tags.Facebook)){
                setNativeFacebook(frameLayout,myApplication.natfacebook);

            }else if (myApplication.defualtAd.equalsIgnoreCase(GFX.Tags.Mix)){
                setNativeMix(frameLayout,myApplication.natAdMob,myApplication.natfacebook);
            ...
            if (GFX.useCRYPTDATA){
                ...
                if (GFX.NetworkDefault.equalsIgnoreCase(GFX.Tags.AdMob)){
                    try {
                        setNativeAdMob(frameLayout, Hexing.getStrings(GFX.NativeAds_AdMob));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    ...
                    try {
                        setNativeFacebook(frameLayout,Hexing.getStrings(GFX.NativeAds_Facebook));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }else if (GFX.NetworkDefault.equalsIgnoreCase(GFX.Tags.Mix)){
                    try {
                        setNativeMix(frameLayout,Hexing.getStrings(GFX.NativeAds_AdMob),Hexing.getStrings(GFX.NativeAds_Facebook));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
                ...
                if (GFX.NetworkDefault.equalsIgnoreCase(GFX.Tags.AdMob)){
                    setNativeAdMob(frameLayout,GFX.NativeAds_AdMob);
                }else if (GFX.NetworkDefault.equalsIgnoreCase(GFX.Tags.Facebook)){
                    setNativeFacebook(frameLayout,GFX.NativeAds_Facebook);
                }else if (GFX.NetworkDefault.equalsIgnoreCase(GFX.Tags.Mix)){
                    setNativeMix(frameLayout,GFX.NativeAds_AdMob,GFX.NativeAds_Facebook);
                }
            }
        }
