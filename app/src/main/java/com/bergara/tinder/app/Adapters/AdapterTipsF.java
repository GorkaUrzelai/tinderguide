package com.bergara.tinder.app.Adapters;
...
import com.bergara.tinder.app.Holders.AdHolder;
import com.bergara.tinder.app.Holders.HolderList;
...
public class AdapterTipsF extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // private static final int AD_DISPLAY_FREQUENCY = GFX.NumberOfNativeAdInList_Facebook;
